...
export default function OrderCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setCashappId(initialValues.cashappId);
    ...
    setOrderHash(initialValues.orderHash);
    setShipped(initialValues.shipped);
    setShippingType(initialValues.shippingType);
    setShippingCost(initialValues.shippingCost);
    setShipporateObjectId(initialValues.shipporateObjectId);
    setCartTotalWeight(initialValues.cartTotalWeight);
    setLabelURL(initialValues.labelURL);
